...
map.getView().fit([-8828496.014217, -858119.626577, -8683591.842673, -661949.414679], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">CENTROS EDUCATIVOS DE LAS PROVINCIAS DEL SUR DE LA REGIÓN DE CAJAMARCA</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (99 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'Centros educativos que forman parte del ámbito de intervención de la Unidad Territorial Cajamarca 1';
            }
